          ...
          <div class="Page">
            <div class="Page-body">
              ...
              <div class="Page-document">
                ...
                <h2 class="Page-title">Nombre del Proyecto</h2>

                <?php include "./inc/page-info.php"; ?> 

                <p class="Page-description u-mb6">Resumen: descripción mínima que describe de qué se trata el proyecto, máximo 1000 caracteres. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo esse beatae, nihil doloribus dolor perferendis quas voluptatem atque.</p>
                ...
                <h3>Período</h3>
                <p class="u-mb0">Fecha de inicio: <strong>20/04/2017</strong></p>
                <p>Fecha de fin: <strong>21/08/2018</strong></p>
