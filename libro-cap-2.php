<?php
  $title = 'Nombre del capítulo 2 | Libro';
?>
                    ...
                    <div class="Grid">
                            ...
                            <div class="Page">
                                <div class="Page-body">
                                    ...
                                    <div class="Page-document">
                                        ...
                                        <h2 class="Page-title">Nombre del capítulo 2</h2>
                                        ...
                                        <h3 id="subcapitulo-1">Subcapítulo 1</h3>
                                        ...
                                        <h3 id="subcapitulo-2">Subcapítulo 2</h3>
                                        ...
                                        <h3 id="subcapitulo-3">Subcapítulo 3</h3>
                                ...
                                <div class="Pagination u-mb6 u-md-mb3">
                                    <div class="Pagination-text">Viendo el capítulo 2 de 15</div>
                                    <ul class="Pagination-links u-mb2">
                                        <li class="Pagination-prev u-mb3 u-textLeft"><a href="libro.php">Nombre del capítulo de más caracteres que lo que debería ser un título medianamente largo dentro de un contenido del tipo libro, por eso se alinea y agrega márgen al botón para separarse del de abajo.</a></li>
                                        <li class="Pagination-next u-mb3 u-textRight"><a href="libro-cap-2.php">Nombre del capítulo 3</a></li>
                                    </ul>
                                    <a href="libro-indice.php">Ir al Índice</a>
                                </div>
                        ...
                        <div class="Grid-item u-md-size3of10">
                            ...
                            <div class="Box Box--mf">
                                <div class="Page-index Index js-pageIndex js-pageIndexMobile u-mb0">
                                    <div class="Index-header">
                                        <a href="libro-indice.php" accesskey="i" class="Index-trigger js-toggleIndex">
                                            <span>Índice</span> <span class="Index-close">Cerrar</span>
                                        </a>
                                    </div>
