          ...
          <div class="Page">
            <div class="Page-body">
              ...
              <div class="Page-document">
                ...
                <h2 class="Page-title">Nombre del Plan</h2>

                <?php include "./inc/page-info.php"; ?> 


                <p class="Page-description u-mb6">Resumen: descripción mínima que describe de qué se trata el plan, máximo 1000 caracteres. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo esse beatae, nihil doloribus dolor perferendis quas voluptatem atque.</p>
