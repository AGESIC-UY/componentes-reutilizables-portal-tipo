<?php
  $title = 'Nombre del capítulo 1 | Libro';
?>
                            ...
                            <div class="Page">
                                <div class="Page-body">
                                    ...
                                    <div class="Page-document">
                                        ...
                                        <h2 class="Page-title">Nombre del capítulo 1</h2>
                                ...
                                <div class="Pagination u-mb6 u-md-mb3">
                                    <div class="Pagination-text">Viendo el capítulo 1 de 15</div>
                                    <ul class="Pagination-links u-mb2">
                                        <li class="Pagination-next u-mb3 u-textRight"><a href="libro-cap-2.php">Nombre del capítulo 2</a></li>
                                    </ul>
