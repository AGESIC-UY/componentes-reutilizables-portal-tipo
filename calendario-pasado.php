          ...
          <div class="Grid-item u-md-size3of4">
            <div class="Page-body">
              ...
              <div class="Page-document">
               ...
               <h2 class="Page-title">Actividades anteriores</h2>

               <div class="Page-info u-mb6">
                  <div class="Bar">
                    <div class="Bar-cell">
                      <a href="calendario.php" class="Button Button--inverse Button--small">Ver calendario de próximas actividades</a>
                    </div>
                    <div class="Bar-cell">
                 ...
                 <ul class="List List--media">
                  <li class="Media">
                    ...
                    <div class="Media-body">
                      ...
                      <h3 class="Event-title"><a href="#">Capacitación: la gestión de riesgos y daños</a></h3>
                  ...
                  <li class="Media">
                    ...
                    <div class="Media-body">
                      <a href="subhome.php" class="Event-name">Nombre del evento</a>
                      <span class="Box-info">19:30 - Lugar de la actividad</span>
                      <h3 class="Event-title"><a href="#">Lorem ipsum</a></h3>
