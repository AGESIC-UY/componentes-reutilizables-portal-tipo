	...
	<button class="js-searchTrigger Button--w-icon">
		<span class="search">
			...
			<svg fill="#000000" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 14 14">
				<path d="M5.9,10.9C3.2,10.9,1,8.7,1,5.9S3.2,1,5.9,1s4.9,2.2,4.9,4.9S8.7,10.9,5.9,10.9z M5.9,1.9c-2.2,0-4.1,1.8-4.1,4.1 S3.7,10,5.9,10C8.2,10,10,8.2,10,5.9S8.2,1.9,5.9,1.9z"/>
				<path d="M9.4,8.8l3.6,3.6L12.4,13L8.8,9.4L9.4,8.8z"/>
			</svg>
		</span>
		<span class="close">
