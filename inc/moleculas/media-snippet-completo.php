<!--<li class="Media">-->
	<div class="Media-image">
			<img src="img/ruta.jpg" alt="Carretera centrada en subida">
	</div>
	<div class="Media-body">
			<span class="Box-info">15/01/2023 - Estado [<strong>Vigente</strong> / No vigente]</span>
			<h3>
				<a href="documento.php">Título del formato genérico completo que puede ser largo y pasar a más de una línea</a>
			</h3>
			<span class="Box-info"><strong>Dato destacado / Categoría</strong> - <span>Info adicional</span></span>
