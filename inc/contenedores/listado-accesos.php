<div class="Box Box--mf Box--listadoAccesos">
	...
	<div class="Box-body">
			<p class="Box-text">Texto adicional de la variante con imagen en una columna.</p>
 ...
 * Clases modificadoras
	 - De diseño: Box--listadoNoImage
	 - Columnas en la grilla (Grid +): Grid--rowSize2, Grid--rowSize3
 ...
 * Textos (No dejar etiquetas html vacías cuando los campos opcionales quedan sin valor, se eliminan)
	 ...
	 - Box-text: Óptiomo 160 caracteres.
	 - Box-title: Óptimo 80 caracteres. Obligatorio.
	 - Box-info: Óptimo 90 caracteres.
	 - Box-footerLink: Óptimo 40 caracteres. 
-->